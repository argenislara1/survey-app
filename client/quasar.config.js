...
export default defineConfig((ctx) => {
  return {
    ...
    build: {
      ...
      env: {
       SERVER_URL: ctx.dev ? 'http://localhost:3000' : 'http://172.31.30.18',
       CREATOR_NAME: 'Argenis Lara',
       CREATOR_EMAIL: 'argenislara2810@gmail.com',
       LINKEDIN: 'https://www.linkedin.com/in/ArgenisLara/'
     },
